...
if(isset($_POST['updatesubmit'])){
    ...
    if($profile_email != $login_email){
        ...
        if(mysqli_num_rows($checkemail_result)<=0){
            ...
            /* Check whether admin change password or not */
            ...
            $editprofile_sql= "update user set userEmail = '$profile_email',userUsername = '$profile_username',".$changepassword.",userPhoneNumber = '$profile_phone' where userEmail = '$login_email'";
        ...
        $editprofile_sql= "update user set userUsername = '$profile_username',".$changepassword."userPhoneNumber = '$profile_phone' where userEmail = '$profile_email'";
        mysqli_query($conn,$editprofile_sql);
        if(mysqli_affected_rows($conn)<=0){
            echo "<script>alert('Updated failed')</script>";
            echo "<script>window.location.href='admin_page_index.php';</script>";
