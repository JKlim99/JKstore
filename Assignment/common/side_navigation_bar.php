<div>
	<table style="position:fixed;top:6vw;z-index:1000;right:-120px;"cellspacing="55vw">
		...
		<tr >
			<td>
				<a class="quickNavigationBar" href="result.php?target=prodcut&search-key=" style="text-decoration:none;"><!--SIDEBAR PRODUCTS-->
					<img style="background-color:orange;animation:anim 2s 0.3s backwards;" src="images/logo/category.png"  alt="category"/>
					<span class="category-text" style="border-color:orange;text-shadow:orange 2px 2px 0px,orange 1px -1px 0,orange -1px 1px 0;animation:category-text-anim 3s 0.3s;">Products</span>
				</a>
			</td>
		...
		<tr >
			<td>
				<a class="quickNavigationBar" href="result.php?target=sale&search-key=" style="text-decoration:none;"><!--SIDEBAR SALE-->
		...
		<tr >
			<td>
				<a class="quickNavigationBar" href="result.php?target=seller&search-key=" style="text-decoration:none;"><!--SIDEBAR SELLERS-->
		...
		<tr >
			<td>
				<a class="quickNavigationBar" href="aboutus.php"style="text-decoration:none;"><!--SIDEBAR ABOUT US-->
		...
		<tr >
			<td>
				<a class="quickNavigationBar" href="help_and_contact.php" style="text-decoration:none;"><!--SIDEBAR HELP & CONTACT-->
